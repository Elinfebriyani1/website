...
<!-- Mirrored from kodeforest.net/html/books/library/event-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Dec 2018 05:16:59 GMT -->
<head>
<meta charset="utf-8">
    ...
    <div class="kode-content padding-tb-50">
    	<div class="container">
            ...
            <div class="kode-event-detail">
            	<div class="kode-event-detail-thumb">
                	<div class="social-icon">
                    	<ul>
                        	<li><a href="#"><i class="fa fa-facebook"></i></a></li>
                    ...
                    <div class="kode-caption">
                    	<div class="row">
                        	<div class="col-md-5">
                            	<h3>Oxford University Convention</h3>
                ...
                <div class="kode-event-text">
                	<div class="row">
                    	<div class="col-md-4">
                    		<div class="kode-event-info">
                        	<h2>Detail:</h2>
							<table>
								<tr>
									<td>Date:</td>
								...
								<tr>
									<td>Ticket:</td>
									<td><a href="mailto:info@bookstore.com">info@bookstore.com</a></td>
								</tr>
								<tr>
									<td>Tell:</td>
									<td>0041-875-6325</td>
								...
								<tr>
									<td>Category:</td>
									<td>Books Exhibition</td>
								</tr>
							</table>
							<a href="#" class="book-now">Book Now</a>
							<a href="#" class="book-now">Attend</a>
                            </div>
                        </div>
                        <div class="col-md-8">
                        	<h2>Description</h2>
                            <h4>Books Exhibition in Oxford Univercity</h4>
                            <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.</p>
                            <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor.</p>
                            <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, am erat, sed diam voluptua.</p>
                        </div>
                    </div>
                </div>
                <!--LOCATION MAP-->
        ...
        <div class="event-gallery">
            <div class="container">
                ...
                <div class="grid row">
                  ...
                  <div class="grid-item">
                    <a href="#"><img src="images/event-gallery1.png" alt=""></a>
                  </div>
                  <div class="grid-item">
                    <a href="#"><img src="images/event-gallery2.png" alt=""></a>
                  </div>
                  <div class="grid-item">
                    <a href="#"><img src="images/event-gallery3.png" alt=""></a>
                  </div>
                  <div class="grid-item">
                    <a href="#"><img src="images/event-gallery4.png" alt=""></a>
                  </div>
                  <div class="grid-item">
                    <a href="#"><img src="images/event-gallery5.png" alt=""></a>
                  </div>
                  <div class="grid-item">
                    <a href="#"><img src="images/event-gallery6.png" alt=""></a>
                  </div>
                </div>
            </div>
        </div>
        <!--OUR SPEAKERS START-->
        <div class="kode-speakers">
        	<div class="container">
            	<h2>Our Speakers</h2>
            	<div class="row">
                	<div class="col-md-4 col-sm-6">
                        <div class="kode-author kode-author-2">
                            <a href="#"><img alt="" src="images/speakers1.png"></a>
                            <div class="kode-caption">
                                <h4>Saul Bellow</h4>
                                <p>Authors</p>
                                <div class="social-icon">
